...
-(void)showMMClassPopup
{
    MMPopupViewController* mmClassPopupViewController = [[MMPopupViewController alloc] initWithNibName:nil bundle:nil];
    
    mmClassPopupViewController.delegate = self;
    [[[UIApplication sharedApplication] keyWindow] addSubview:mmClassPopupViewController.view];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    if ([[segue identifier] isEqualToString:@"showDetail"]) {
        ...
        [[segue destinationViewController] setDetailItem:mmClass];
    }
}
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"MMClass" inManagedObjectContext:self.managedObjectContext];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    MMClass *mmClass = [self.fetchedResultsController objectAtIndexPath:indexPath];
    cell.textLabel.text = mmClass.name;
}
...
-(void)didCloseWithText:(NSString*)text
{
    ...
    MMClass* mmClass = [NSEntityDescription insertNewObjectForEntityForName:@"MMClass" inManagedObjectContext:context];
